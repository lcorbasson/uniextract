...
Name: modifypath; Description: Add Universal Extractor to your system &path; Check: IsAdminLoggedOn() or IsPowerUserLoggedOn()
...
Root: HKCR; SubKey: {reg:HKCR\.lit,}\shell\uniextract; ValueType: string; ValueData: UniExtract &Files...; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\files; Check: RVE('.lit')
...
Root: HKCR; SubKey: {reg:HKCR\.lit,}\shell\uniextract_here; ValueType: string; ValueData: UniExtract &Here; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\here; Check: RVE('.lit')
...
Root: HKCR; SubKey: {reg:HKCR\.lit,}\shell\uniextract_sub; ValueType: string; ValueData: UniExtract to &Subdir; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\subdir; Check: RVE('.lit')
...
Root: HKCR; SubKey: {reg:HKCR\.wz,}\shell\uniextract; ValueType: string; ValueData: UniExtract &Files...; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\files; Check: RVE('.wz')
...
Root: HKCR; SubKey: {reg:HKCR\.wz,}\shell\uniextract_here; ValueType: string; ValueData: UniExtract &Here; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\here; Check: RVE('.wz')
...
Root: HKCR; SubKey: {reg:HKCR\.wz,}\shell\uniextract_sub; ValueType: string; ValueData: UniExtract to &Subdir; Flags: uninsdeletekey; Tasks: associate and not associate\force and associate\subdir; Check: RVE('.wz')
